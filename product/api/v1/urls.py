...
from api.v1.views.course_view import CourseViewSet, GroupViewSet, LessonViewSet, AvailableCoursesViewSet
from api.v1.views.user_view import UserViewSet

v1_router = DefaultRouter()
v1_router.register('users', UserViewSet, basename='users')
v1_router.register('available-courses', AvailableCoursesViewSet, basename='available-courses')
